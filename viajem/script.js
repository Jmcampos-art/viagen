...
const destinations = [
  ...
  { id: 4, name: "Botucatu", country: "Brasil", state: "São Paulo", region: "Sudeste", climate: "ameno", climateLabel: "Ameno / Subtropical", bestMonths: [4,5,6,7,8,9], pricing: { flight: null, bus: 120, hotelPerNight: 180, tours: 150 }, transport: { recommended: "bus", flightAvailable: false, busAvailable: true, distanceKm: 230 }, attractions: ["Cuesta de Botucatu", "Praça Rubião Júnior", "Museu do Café", "Parque Municipal", "Igreja Matriz"], image: "https://images.unsplash.com/photo-1596394516093-501ba68a0ba6?q=80&w=1470&auto=format&fit=crop", description: "Cidade serrana do interior paulista, com a famosa Cuesta.", rating: 8.3, idealDays: 3, tips: "Visite a Cuesta ao pôr do sol.", activities: [
    { day: 1, title: "Centro", desc: "Praça e igreja matriz." },
    { day: 2, title: "Cuesta", desc: "Trilha e mirante." },
    { day: 3, title: "Museu", desc: "História local e gastronomia." }
  ]},
  { id: 5, name: "Bauru", country: "Brasil", state: "São Paulo", region: "Sudeste", climate: "ameno", climateLabel: "Ameno / Tropical", bestMonths: [4,5,6,7,8,9], pricing: { flight: null, bus: 100, hotelPerNight: 180, tours: 150 }, transport: { recommended: "bus", flightAvailable: false, busAvailable: true, distanceKm: 330 }, attractions: ["Parque Vitória Régia", "Zoológico Municipal", "Museu do Café", "Praça da Paz"], image: "https://images.unsplash.com/photo-1596394516093-501ba68a0ba6?q=80&w=1470&auto=format&fit=crop", description: "Terra do sanduíche Bauru e do zoológico.", rating: 8.1, idealDays: 3, tips: "Prove o sanduíche Bauru original.", activities: [
    { day: 1, title: "Centro", desc: "Praça e história." },
    { day: 2, title: "Zoológico", desc: "Zoo municipal." },
    { day: 3, title: "Parque", desc: "Vitória Régia." }
  ]},
  { id: 6, name: "Campinas", country: "Brasil", state: "São Paulo", region: "Sudeste", climate: "ameno", climateLabel: "Ameno / Tropical de Altitude", bestMonths: [4,5,6,7,8], pricing: { flight: null, bus: 90, hotelPerNight: 220, tours: 200 }, transport: { recommended: "bus", flightAvailable: false, busAvailable: true, distanceKm: 100 }, attractions: ["Bosque dos Jequitibás", "Parque Portugal", "Museu do Café", "Mercado Municipal"], image: "https://images.unsplash.com/photo-1580060839134-75a5edca2e99?q=80&w=1470&auto=format&fit=crop", description: "Terra do café e da tecnologia.", rating: 8.4, idealDays: 2, tips: "Visite o Bosque dos Jequitibás.", activities: [
  ...
  { id: 9, name: "Fortaleza", country: "Brasil", state: "Ceará", region: "Nordeste", climate: "calor", climateLabel: "Quente / Tropical", bestMonths: [8,9,10,11], pricing: { flight: 1100, bus: null, hotelPerNight: 250, tours: 300 }, transport: { recommended: "flight", flightAvailable: true, busAvailable: false, distanceKm: 3100 }, attractions: ["Praia do Futuro", "Beach Park", "Dragão do Mar"], image: "https://images.unsplash.com/photo-1596394516093-501ba68a0ba6?q=80&w=1470&auto=format&fit=crop", description: "Dunas e praias mornas.", rating: 8.7, idealDays: 4, tips: "Vá ao Beach Park em dia de semana.", activities: [
  ...
  { id: 11, name: "Paris", country: "França", state: "Île-de-France", region: "Europa", climate: "ameno", climateLabel: "Ameno / Continental", bestMonths: [4,5,6,9,10], pricing: { flight: 4500, bus: null, hotelPerNight: 650, tours: 700 }, transport: { recommended: "flight", flightAvailable: true, busAvailable: false, distanceKm: 9400 }, attractions: ["Torre Eiffel", "Louvre", "Montmartre"], image: "https://images.unsplash.com/photo-1502602898657-3e91760cbb34?q=80&w=1470&auto=format&fit=crop", description: "Romance e arte.", rating: 9.6, idealDays: 6, tips: "Compre ingressos online.", activities: [
  ...
  { id: 14, name: "Santiago", country: "Chile", state: "Santiago", region: "América do Sul", climate: "ameno", climateLabel: "Ameno / Andino", bestMonths: [3,4,5,9,10,11], pricing: { flight: 2200, bus: null, hotelPerNight: 350, tours: 400 }, transport: { recommended: "flight", flightAvailable: true, busAvailable: false, distanceKm: 2600 }, attractions: ["Cerro San Cristóbal", "Valparaíso", "Vinícolas"], image: "https://images.unsplash.com/photo-1518659526054-190340b32735?q=80&w=1470&auto=format&fit=crop", description: "Andes e vinhos.", rating: 8.9, idealDays: 4, tips: "Visite vinícolas.", activities: [
...
function aiGenerateItinerary() {
  ...
  const scored = pool.map(dest => ({ ...dest, _score: dest.rating * 10 + (month && dest.bestMonths.includes(Number(month)) ? 15 : 0) }));
  ...
  for (const dest of scored) {
    ...
    if (!usedClimates.has(dest.climate)) { chosen.push(dest); usedClimates.add(dest.climate); }
  }
  for (const dest of scored) {
    if (chosen.length >= numDestinos) break;
